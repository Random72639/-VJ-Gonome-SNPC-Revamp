...
-----------------------------------------------*/
ENT.Model = {"models/1_rnds_gonomes/hl2_beta_gonome/zombie_assassin.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 500
